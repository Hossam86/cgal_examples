...
namespace boost {
template <>
struct graph_traits<My::Mesh>:public boost::graph_traits<My::Mesh::Base>
{};

template <typename T>
struct property_map<My::Mesh,T>:public boost::property_map<My::Mesh::Base,T>
{};
}

namespace CGAL {
template <typename T>
struct graph_has_property<My::Mesh,T>:public CGAL::graph_has_property<My::Mesh::Base,T>
{};
}
...
{
    My::Mesh mesh;
    CGAL::make_triangle(Point(0,0,0), Point(1,0,0), Point(1,1,1), mesh);
